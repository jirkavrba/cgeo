...
public class BranchDetectionHelper {
    ...
    public static final String FEATURE_VERSION_NAME = "mapy.cz.proxy";
    ...
    public static final String[] BUGFIX_VERSION_NAME = new String[]{ "2024.04.05", "2024.04.13", "2024.04.18", "2024.04.25" };
